...
import { createOrderBodySchema, staffOrderStatusSchema, addPaymentSchema, addIssuedMaterialSchema, updateReturnedMaterialSchema, } from '../validators/schemas.js';
import { createOrder, getMyOrders, getOrderById, updateOrder, updateOrderStatus, requestRevision, addPayment, getPayments, addIssuedMaterial, updateReturnedMaterial } from '../controllers/staff.controller.js';
const router = express.Router();
router.use(protect);
router.use(authorize('STAFF'));
// Order routes
router.post('/orders', uploadMiddleware.array('images', 5), validateMediaSize, validateBody(createOrderBodySchema), createOrder);
